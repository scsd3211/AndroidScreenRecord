...
public class NamedSpinner extends LinearLayout {
    ...
    public NamedSpinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, styleable.NamedSpinner, defStyleAttr, defStyleRes);
        final CharSequence[] entries = a.getTextArray(styleable.NamedSpinner_android_entries);
        if (entries != null) {
        ...
        int textAppearance = a.getResourceId(styleable.NamedSpinner_android_textAppearance,
                android.R.style.TextAppearance_DeviceDefault_Medium);
        CharSequence title = a.getText(styleable.NamedSpinner_android_name);
