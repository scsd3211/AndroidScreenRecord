...
import screenrecordstore.Encoder.Callback;


public class SpeakerRecorder implements Encoder{
	 ...
	 private static final String TAG = "MicRecorder";
	    ...
	    SpeakerRecorder(AudioEncodeConfig config) {
	    ...
	    private static class CallbackDelegate extends Handler {
	        ...
	        void onError(final Encoder encoder, final Exception exception) {
	        	 Runnable mmCallback = new Runnable() {
	            ...
	            Message.obtain(this,mmCallback
	            ).sendToTarget();
	        }
	        ...
	        void onOutputFormatChanged(final BaseEncoder encoder, final MediaFormat format) {
	            ...
	            Message.obtain(this, mmCallback).sendToTarget();
	        }
	            ...
	            switch (msg.what) {
	                case MSG_PREPARE:
	                    ...
	                    if (r == null) {
	                        ...
	                        mCallbackDelegate.onError(SpeakerRecorder.this, new IllegalArgumentException());
	                        break;
	                    } else {
	                        r.startRecording();
	                        mMic = r;
	                    ...
	                    try {
	                        ...
	                        mCallbackDelegate.onError(SpeakerRecorder.this, e);
	                        break;
	                    }
	                case MSG_FEED_INPUT:
	                    if (!mForceStop.get()) {
